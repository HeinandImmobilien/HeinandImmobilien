...
def location_search_widget():
  ...
  <label for="ort-suche" class="eyebrow" style="display:block;margin-bottom:10px;">Sind wir auch in Ihrem Ort tätig?</label>
  <div class="location-search-box">
    <input type="text" id="ort-suche" class="location-search-input" placeholder="Ort eingeben, z. B. Schwabsburg, Nierstein, Frankfurt …" autocomplete="off">
...
<div class="cookie-banner">
  ...
  <p>Wir verwenden technisch notwendige Cookies. Mit Ihrer Einwilligung nutzen wir zusätzlich eine anonyme, eigene Besucher-Statistik ohne Drittanbieter-Tracking. Details in der <a href="{prefix}datenschutz.html">Datenschutzerklärung</a>.</p>
